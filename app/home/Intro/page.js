...
function Page() {
    ...
    return (
        <div className={`flex flex-col items-center space-y-8 p-8 text-${theme === 'dark' ? 'white' : 'gray-800'} ${theme === 'dark' ? 'bg-gradient-to-b from-gray-900 to-gray-900' : 'bg-gradient-to-b from-teal-50 to-white'}`}>
